...
interface ReconciliationFormProps {
  onSubmit: (request: ReconciliationRequest) => void;
  loading?: boolean;
}
...
export function ReconciliationForm({ onSubmit, loading = false }: ReconciliationFormProps) {
  ...
  const updatePatientContext = (field: keyof typeof formData.patient_context, value: any) => {
    setFormData(prev => ({
      ...prev,
      patient_context: {
  ...
  const updateSource = (index: number, field: keyof MedicationSource, value: any) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => updateSource(index, 'source_reliability', e.target.value as any)}
